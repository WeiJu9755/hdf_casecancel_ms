...
$fellow_count = 0;
//取得指定管理人數
$pjmyfellow_row = getkeyvalue2($site_db."_info","pjmyfellow","web_id = '$web_id' and project_id = '$project_id' and auth_id = '$auth_id' and pro_id = 'casecancel'","count(*) as fellow_count");
...
$pjItemManager = false;
//檢查是否為指定管理人
$pjmyfellow_row = getkeyvalue2($site_db."_info","pjmyfellow","web_id = '$web_id' and project_id = '$project_id' and auth_id = '$auth_id' and pro_id = 'casecancel' and member_no = '$memberID'","count(*) as enable_count");
	...
	<table class="table table-bordered border-dark w-100" id="db_table" style="min-width:1200px;">
		<thead class="table-light border-dark">
			<tr style="border-bottom: 1px solid #000;">
				...
				<th class="text-center text-nowrap" style="width:16%;padding: 10px;background-color: #CBF3FC;">工程名稱</th>
				<th class="text-center text-nowrap" style="width:6%;padding: 10px;background-color: #CBF3FC;">經辦人員</th>
				<th class="text-center text-nowrap" style="width:12%;padding: 10px;background-color: #CBF3FC;">評估建物棟數</th>
				...
				<th class="text-center text-nowrap" style="width:10%;padding: 10px;background-color: #CBF3FC;">初評狀態</th>
				<th class="text-center text-nowrap" style="width:10%;padding: 10px;background-color: #CBF3FC;">備註</th>
...
<script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function() {
		$('#db_table').dataTable( {
			...
			"ordering": false,
			"ajaxSource": "/smarty/templates/$site_db/$templates/sub_modal/project/func01/casecancel_ms/server_casecancel.php?site_db=$site_db&fm=$fm",
			"language": {
						"sUrl": "$dataTable_de"
			...
			"fnRowCallback": function( nRow, aData, iDisplayIndex ) { 
				...
				$('td:eq(9)', nRow).html( '<div class="d-flex justify-content-center align-items-center text-center size12 text-nowrap" style="height:auto;min-height:32px;">'+preliminary_status+'</div>' );
