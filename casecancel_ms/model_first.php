...
switch($ch) {
	case 'edit':
		$title = "編輯作業";
		$sid = "view01";
		$modal = $m_location."/sub_modal/project/func01/casecancel_ms/casecancel_modify.php";
		include $modal;
	...
	case 'ch_employee':
		...
		if (empty($sid))
			$sid = "view01";
		$modal = $m_location."/sub_modal/project/func01/casecancel_ms/ch_employee.php";
		include $modal;
		$smarty->assign('show_center',$show_center);
		$smarty->assign('xajax_javascript', $xajax->getJavascript('/xajax/'));
		break;
	default:
		if (empty($sid))
			$sid = "mbpjitem";
		$modal = $m_location."/sub_modal/project/func01/casecancel_ms/casecancel.php";
		include $modal;
		$smarty->assign('xajax_javascript', $xajax->getJavascript('/xajax/'));
		break;
};
